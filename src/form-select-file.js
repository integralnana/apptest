...
export default function FormSelectFile() {
  ...
  let maxNumFilesOptions = [1, 2, 3, 4, 5]; // จำนวนไฟล์ที่เลือกได้
  let maxSizeOptions = [50, 100, 200, 500, 1000]; // ขนาดสูงสุดของไฟล์ (KB)
  ...
  return (
    <div className="mt-4 container p-3 rounded" style={{ width: '400px', background: '#cee' }}>
      <form>
